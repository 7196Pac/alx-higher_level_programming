...
#         s1 = Square(3, 5, 1, 7)
OBOBOB#         s1_dictionary = s1.to_dictionary()
#         s2 = Square.create(**s1_dictionary)
...
#     @classmethod
#     def tearDown(self):
OBOBOB#         """Delete any created files."""
#         try:
#             os.remove("Rectangle.json")
#         except IOError:
#             pass
...
#         r1 = Rectangle(10, 7, 2, 8, 5)
OBOBOB#         r2 = Rectangle(2, 4, 1, 2, 3)
...
OBOBOB#         with open("Square.csv", "r") as f:
...
OAOAOA#     def test_load_from_file_csv_rectangle_types(self):
#         r1 = Rectangle(10, 7, 2, 8, 1)
#         r2 = Rectangle(2, 4, 5, 6, 2)
#         Rectangle.save_to_file_csv([r1, r2])
